...
class Item extends CI_Model{
    ...
    */
    ...
    public function incrementItem($itemId, $numberToadd){
        $q = "UPDATE semesters SET quantity = quantity + ? WHERE id = ?";
    ...
    */
    ...
    public function decrementItem($itemCode, $numberToRemove){
        $q = "UPDATE semesters SET quantity = quantity - ? WHERE career = ?";
   ...
   public function newstock($itemId, $qty){
       $q = "UPDATE semesters SET quantity = quantity + $qty WHERE id = ?";
