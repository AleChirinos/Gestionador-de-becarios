...
class Reservation extends CI_Model {
     ...
     * @param type $_tt reservation type whether (sale{1} or return{2})
     * @param type $ref
    ...
    /**
     * Get all reservations with a particular ref
     * @param type $ref
     * @return boolean
     */
    ...
    /**
     * selects the total number of reservations done so far
     * @return boolean
     */
