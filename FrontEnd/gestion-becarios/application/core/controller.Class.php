...
class Connect extends PDO{
    public function __construct(){
        parent::__construct("mysql:host=localhost;dbname=1410inventory", 'root', '',
...
class Controller {
    ...
    function checkUserExist($email, $sess){
        $db = new Connect;
    ...
    function insertData($data)
    {
        ...
        if(!$info["id"]){
            ...
            if($insertNewUser){
                ...
                setcookie("email", $db->lastInsertId(), time()+60*60*24*30, "/", NULL);
