...
<div class="row hidden-print">
    <div class="col-sm-12">
        <div class="pwell">
            <!-- Header (add new supplier, sort order etc.) -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 fa fa-user-plus pointer" style="color:#337ab7" data-target='#addNewSupplierModal' data-toggle='modal'>
                        Nuevo Proveedor
                    </div>
                    <div class="col-sm-3 form-inline form-group-sm">
                        <label for="supplierListPerPage">Mostrar</label>
                        <select id="supplierListPerPage" class="form-control">
                        ...
                        <label for="supplierListPerPage">por página</label>
                    </div>
                    <div class="col-sm-4 form-inline form-group-sm">
                        <label for="supplierListSortBy" class="control-label">Ordenar por</label>
                        <select id="supplierListSortBy" class="form-control">
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        <label for="supplierSearch"><i class="fa fa-search"></i></label>
                        <input type="search" id="supplierSearch" placeholder="Buscar...." class="form-control">
                    </div>
                </div>
            </div>
            ...
            <!-- Supplier list -->
            <div class="row">
                <div class="col-sm-12" id="allSupplier"></div>
            </div>
            <!-- Supplier list ends -->
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="reset" form="addNewSupplierForm" class="btn btn-warning pull-left">Limpiar</button>
                <button type='button' id='addSupplierSubmit' class="btn btn-primary">Añadir PROVEEDOR</button>
...
<div class='modal fade' id='editSupplierModal' role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class='modal-header'>
                <button class="close" data-dismiss='modal'>&times;</button>
                <h4 class="text-center">Editar información de proveedor</h4>
                <div class="text-center">
                    <i id="fMsgEditIcon"></i>
            ...
            <div class="modal-footer">
                <button type="reset" form="editSupplierForm" class="btn btn-warning pull-left">Limpiar</button>
                <button type='button' id='editSupplierSubmit' class="btn btn-primary">Actualizar</button>
                <button type='button' class="btn btn-danger" data-dismiss='modal'>Cerrar</button>
            </div>
        </div>
    </div>
...
<script src="<?=base_url()?>public/js/supplier.js"></script>