                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><?=$this->genmod->gettablecol('transactions', 'SUM(quantity)', 'itemCode', $get->career)?></td>
                                      <td> Bs. <?=number_format($this->genmod->gettablecol('transactions', 'SUM(totalPrice)', 'itemCode', $get->career), 2)?></td>
                                    <?php $sn++; ?>
